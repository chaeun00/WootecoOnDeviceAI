...
## 2. 사용 기술 및 모델: Mobilenet_v2

> 해당 모델 TensorFlow Hub 링크: https://www.kaggle.com/models/tensorflow/mobilenet-v2

- 모바일에 최적화된 경량 모델이며, 성능 또한 준수하다고 평가받기에 이 모델을 선택한다.
...
- **[핵심] 이미지 분류:**
    ...
    - [ ] 촬영된 이미지를 TFLite 모델로 분석한다.
    - [ ] 분석 결과(라벨, 확률)를 화면에 표시한다.
